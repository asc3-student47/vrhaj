...
- **WHEN** a compliance request includes a SKU that exists in the mock database
...
- **WHEN** a compliance request references a SKU or fitment combination not present in the mock database
...
- **WHEN** a tire record satisfies all requested constraints
...
- **WHEN** evaluation completes with no failed rules
...
- **WHEN** evaluation completes with failed rules
